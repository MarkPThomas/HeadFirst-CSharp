...
namespace LeftOver6
{
    ...
    class EquatableGuy : Guy, IEquatable<Guy>
    {
        ...
        /// </summary>
        /// <param name="other">The EquatableGuy to compare with.</param>
        ...
        /// <summary>
        /// Part of the contract for overriding Equals is that you need to override GetHashCode() as well. 
        /// It should compare the values and return true if the values are equal.
        /// </summary>
        /// <returns></returns>
        public override int GetHashCode()
        {
            // This is a pretty standard pattern for the method.
